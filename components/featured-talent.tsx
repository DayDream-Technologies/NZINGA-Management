...
function TalentCardWithScroll({ talent, index, containerRef }: { 
  talent: typeof featuredTalent[0]; 
  index: number;
  ...
  // Scale from 0.85 to 1 as the section scrolls into view
...
export default function FeaturedTalent() {
  ...
  return (
    <section ref={containerRef} className="section-padding bg-[#0a0a0a] relative texture-grain">
